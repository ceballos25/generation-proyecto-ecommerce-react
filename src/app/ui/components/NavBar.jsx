...
const CorotoNavBar = () => {
  ...
  return (
    <nav className="navbar navbar-expand-lg sticky-top bg-white offcanvas-border navbar-container">
        ...
        <div className="collapse navbar-collapse">
          <ul className="navbar-nav mx-auto gap-1">
            <li className="nav-item">
              <a className="nav-link px-3 fw-semibold" href="/">
                Inicio
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link px-3 fw-semibold" href="/about">
                Nosotros
              </a>
            </li>
            <li className="nav-item">

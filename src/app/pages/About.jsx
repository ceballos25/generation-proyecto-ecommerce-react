              ...
              <div className="row align-items-center">
                ...
                <div className="col-md-6 d-flex flex-column align-items-center text-center">
                  ...
                  <p className="lead">
                    ...
                    democratizando el acceso a la tecnología a precios
                    accesibles. En Colombia se desechan más de 400 mil toneladas
                    de equipos electrónicos al año. Nosotros les damos una
                    segunda oportunidad.
                  </p>
                </div>
              </div>
              ...
              <div className="row align-items-center flex-md-row-reverse">
                ...
                <div className="col-md-6 d-flex flex-column align-items-center text-center">
                  ...
                  <p className="lead">
                    ...
                    operará en las principiales ciudades de Colombia,
                    movilizando más de 10,000 dispositivos reacondicionados al
                    año. Cada laptop que vendemos es una tonelada de CO₂
                    evitada. Cada monitor reutilizado es un estudiante que no se
                    queda atrás. Medellín, Bogotá, Cali, Barranquilla, Cartagena
                    — y de ahí hacia cada municipio que necesite acceso a
                    tecnología sin pagar precio de primera.
                  </p>
                </div>
              </div>
            </section>

  ...
  return (
    <div className="register-component-container">
      <div className="info-register-container">
        <div className="d-flex flex-column gap-2 mb-4">
          ...
          <p className="text-secondary mb-0 register-hero-description">
            Crea tu cuenta y accede a todos nuestros servicios de forma rápida y
            segura.
          </p>
        </div>
        ...
        <div className="d-flex gap-2">
          ...
          <div className="border rounded-3 px-3 py-2">
            ...
            <div className="text-secondary register-stat-label">DISPONIBLE</div>
          </div>
          <div className="border rounded-3 px-3 py-2">
            <div className="fw-bold text-success">+5k</div>
            <div className="text-secondary register-stat-label">USUARIOS</div>
          </div>
        </div>
      </div>
      ...
      <div className="register-form-col">
        <form
          id="registroForm"
          className="p-4 needs-validation border rounded shadow-sm bg-white"
          noValidate
        >
